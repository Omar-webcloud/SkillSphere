    ...
    <footer className="bg-base-200 text-base-content mt-auto border-t border-base-300">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10">
          ...
          <div className="sm:col-span-2 lg:col-span-1 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <div className="flex gap-6 mt-6">
              <a className="text-gray-400 hover:text-primary transition-colors cursor-pointer">
              ...
              <a className="text-gray-400 hover:text-error transition-colors cursor-pointer">
              ...
              <a className="text-gray-400 hover:text-blue-600 transition-colors cursor-pointer">
          ...
          <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
            ...
            <ul className="space-y-2.5">
              ...
              <li><Link href="/courses" className="text-sm text-gray-500 hover:text-primary transition-colors">All Courses</Link></li>
              <li><Link href="/profile" className="text-sm text-gray-500 hover:text-primary transition-colors">My Profile</Link></li>
              <li><Link href="/login" className="text-sm text-gray-500 hover:text-primary transition-colors">Student Portal</Link></li>
            </ul>
          </div>
          ...
          <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2.5 justify-center sm:justify-start">
                ...
                <span className="text-sm text-gray-500">support@skillsphere.com</span>
              </li>
              <li className="flex items-start gap-2.5 justify-center sm:justify-start">
                ...
                <span className="text-sm text-gray-500">+880 1712-345678</span>
              </li>
              <li className="flex items-start gap-2.5 justify-center sm:justify-start">
          ...
          <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
            ...
            <ul className="space-y-2.5">
              <li><Link href="/terms" className="text-sm text-gray-500 hover:text-primary transition-colors">Terms & Conditions</Link></li>
      ...
      <div className="border-t border-base-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 flex flex-col items-center justify-center">
          <p className="text-xs sm:text-sm text-gray-500 text-center">Copyright © 2024 SkillSphere Ltd. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
